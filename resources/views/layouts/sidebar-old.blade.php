                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin.election') ? 'active' : '' }}"
                        ...
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-vote-yea ps-2 pe-2 text-center text-dark {{ Request::is('admin.election') ? 'text-white' : 'text-dark' }}"
                                ariahidden="true"></i>
                        </div>-
                        <span
                            class="nav-link-text ms-1 {{ Request::is('admin.election') ? 'text-dark' : 'text-white' }}">Election Management</span>
                    </a>
                </li>
            ...
            @if (Auth::check() && (Auth::user()->hasRole('admin_univ') || Auth::user()->hasRole('admin_fakultas')))
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin.election') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1 {{ Request::is('admin.election') ? 'text-dark' : 'text-white' }}">Election Management</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('#') ? 'active' : '' }}" href="#">
