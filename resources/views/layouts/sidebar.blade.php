            ...
            @if (Auth::check() && Auth::user()->hasRole('superadmin'))
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin.admin_univ.index') ? 'active' : '' }}" href="{{ route('admin.admin_univ.index') }}">
                        ...
                        <span class="nav-link-text ms-1 text-white">Manage Admin Univ</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin.admin_faculty.index') ? 'active' : '' }}" href="{{ route('admin.admin_faculty.index') }}">
                        ...
                        <span class="nav-link-text ms-1 text-white">Manage Admin Fakultas</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin.users.index') ? 'active' : '' }}" href="{{ route('admin.users.index') }}">
                        ...
                        <span class="nav-link-text ms-1 text-white">Voter Management</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin.candidates.index') ? 'active' : '' }}" href="{{ route('admin.candidates.index') }}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;" class="fas fa-lg fa-user-friends ps-2 pe-2 text-center {{ Request::is('admin.candidates.index') ? 'text-white' : 'text-dark' }}" aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin.election') ? 'active' : '' }}" href="{{ route('admin.election') }}">
                        ...
                        <span class="nav-link-text ms-1 text-white">Election Management</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('#') ? 'active' : '' }}" href="#">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;" class="fas fa-lg fa-info-circle ps-2 pe-2 text-center {{ Request::is('#') ? 'text-white' : 'text-dark' }}" aria-hidden="true"></i>
                        </div>
                        <span class="nav-link-text ms-1 text-white">Information Management</span>
                    </a>
                </li>
            @endif
