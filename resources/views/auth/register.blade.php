                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text"
                                class=" mb-2 form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name"
                        ...
                        <div class="form-group">
                            ...
                            <input id="nim" type="text"
                                class="mb-2 form-control{{ $errors->has('nim') ? ' is-invalid' : '' }}" name="nim"
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                class="mb-2 form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email"
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password"
                                class="mb-2 form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                <input id="student_card" type="file"
                                    class="form-control-file mb-2{{ $errors->has('student_card') ? ' is-invalid' : '' }}"
                                    name="student_card" required>
                                @error('student_card')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn mt-2"
                                style="color:white; background-color:#005066">{{ __('Register') }}</button>
                        </div>
                    </form>
                </div>
            </div>
